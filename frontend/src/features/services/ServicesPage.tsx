  ...
  return (
    <section>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        {data?.map((service) => (
          <article key={service.id} className="rounded-2xl bg-white p-4 shadow-sm">
            ...
            <a className="mt-3 block rounded-xl bg-[#FFC107] py-3 text-center font-bold" href={whatsappUrl(`Hola, quiero solicitar el servicio: ${service.nombre}. ¿Podemos coordinar?`)}>
